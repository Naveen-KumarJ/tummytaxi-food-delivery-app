    ...
    <section id="menu-preview" className="py-12 px-4 sm:px-6 md:px-8 bg-white">
      <div className="text-center mb-8">
        <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-gray-800">
          Discover TummyTaxi's Menu
        </h2>
        <p className="text-gray-600 text-sm sm:text-base max-w-2xl mx-auto mt-3">
          From fresh salads to indulgent desserts, TummyTaxi serves a wide variety of mouthwatering meals to match every craving and occasion.
        </p>
      </div>
        ...
        {menu_list.map((item, idx) => (
          ...
          >
            <img
              src={item.menu_image}
              alt={item.menu_name}
              className="w-[16vw] sm:w-[12vw] md:w-[7.5vw] max-w-[80px] md:max-w-[100px] aspect-square object-cover rounded-full mx-auto"
            />
