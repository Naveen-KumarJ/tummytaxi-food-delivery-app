        ...
        {menu_list.map((item, idx) => (
          <div key={idx} className="min-w-[80px] sm:min-w-[100px] md:min-w-[120px] text-center flex-shrink-0">
            <img
              ...
              className={`w-[16vw] sm:w-[12vw] md:w-[7.5vw] max-w-[80px] md:max-w-[100px] aspect-square object-cover rounded-full mx-auto cursor-pointer transition-all duration-200 ease-in-out ${
